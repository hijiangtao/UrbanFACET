...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t1-ressql-xxx" INTO TABLE tjF1mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t2-ressql-xxx" INTO TABLE tjF2mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t3-ressql-xxx" INTO TABLE tjF3mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t4-ressql-xxx" INTO TABLE tjF4mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t5-ressql-xxx" INTO TABLE tjF5mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t6-ressql-xxx" INTO TABLE tjF6mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t7-ressql-xxx" INTO TABLE tjF7mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
...
LOAD DATA INFILE "/var/lib/mysql-files/entropy/matrix/tianjin/t8-ressql-xxx" INTO TABLE tjF8mat COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11) set id=@col1,wpnumber=@col2,vpnumber=@col3,wrnumber=@col4,vrnumber=@col5,ppsval=@col6,tpsval=@col7,apsval=@col8,prsval=@col9,trsval=@col10,arsval=@col11;
