...
CREATE TABLE `tdnormal`.`tsEmatrix` (
  `id` mediumint(8) UNSIGNED NOT NULL,
  `wpnumber` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `vpnumber` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `wrnumber` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
ALTER  TABLE `tdnormal`.`tsEmatrix` ADD PRIMARY KEY (`id`), ADD KEY `wpnumber_3` (`wpnumber`,`vpnumber`,`prsval`,`ppsval`), ADD KEY `wrnumber` (`wrnumber`,`vrnumber`,`prsval`,`ppsval`), ADD KEY `wrnumber_2` (`wrnumber`,`vrnumber`,`trsval`,`tpsval`), ADD KEY `wrnumber_3` (`wrnumber`,`vrnumber`,`arsval`,`apsval`), ADD KEY `wpnumber` (`wpnumber`,`vpnumber`,`trsval`,`tpsval`), ADD KEY `wpnumber_2` (`wpnumber`,`vpnumber`,`arsval`,`apsval`);

LOAD DATA LOCAL INFILE "/home/tao.jiang/datasets/JingJinJi/entropy/matrix/tangshan/respeo-xxx" INTO TABLE tsEmatrix COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9) set id=@col1,wpnumber=@col2,vpnumber=@col3,ppsval=@col4,tpsval=@col5,apsval=@col6;

CREATE TEMPORARY TABLE tmp LIKE tsEmatrix;
LOAD DATA LOCAL INFILE "/home/tao.jiang/datasets/JingJinJi/entropy/matrix/tangshan/resrec-xxx" INTO TABLE tmp COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9) set id=@col1,wrnumber=@col2,vrnumber=@col3,prsval=@col4,trsval=@col5,arsval=@col6;

UPDATE tsEmatrix
INNER JOIN tmp on tsEmatrix.id=tmp.id
SET tsEmatrix.wrnumber = tmp.wrnumber, tsEmatrix.vrnumber = tmp.vrnumber, tsEmatrix.prsval = tmp.prsval, tsEmatrix.trsval = tmp.trsval, tsEmatrix.arsval = tmp.arsval;
...
LOAD DATA LOCAL INFILE "/home/tao.jiang/datasets/JingJinJi/entropy/matrix/zhangjiakou/respeo-xxx" INTO TABLE zjkEmatrix COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9) set id=@col1,wpnumber=@col2,vpnumber=@col3,ppsval=@col4,tpsval=@col5,apsval=@col6;

CREATE TEMPORARY TABLE tmp LIKE zjkEmatrix;
LOAD DATA LOCAL INFILE "/home/tao.jiang/datasets/JingJinJi/entropy/matrix/zhangjiakou/resrec-xxx" INTO TABLE tmp COLUMNS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '' ESCAPED BY '"' LINES TERMINATED BY '\n' (@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9) set id=@col1,wrnumber=@col2,vrnumber=@col3,prsval=@col4,trsval=@col5,arsval=@col6;
