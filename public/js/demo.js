...
let userpanel = new Vue({
    ...
    methods: {
        ...
        changeRegion(item) {
            ...
            this.selections.regionName = item.val
        },
        ...
        clusterTrain() {
            ...
            if (minpts !== '' && eps !== '') {
                ...
                $.post(`/demo/v1/clustertrain`, data, function(res, err) {
                    if (res['scode'] === 1) {
        ...
        labelTrain() {
            ...
            if (theme !== '' && paramval !== '' && id !== '-1') {
                ...
                $.get(`/demo/v1/labeltrain?theme=${theme}&paramval=${paramval}&rangeval=${rangeval}&id=${id}`, function(res, err) {
        ...
        classplot() {
            ...
            $.get(`/demo/v1/classplot?feature=${feature}&srate=${srate}&eps=${eps}&minpts=${minpts}&id=${id}`, function(res, err) {
                if (res['scode'] === 1) {
        ...
        maDisplayQuery() {
            ...
            if (daytype && timeperiod) {
                ...
                $.get(`/demo/v1/madisplay?daytype=${daytype}&timeperiod=${timeperiod}&id=${id}`, function(res, err) {
                    if (res['scode'] === 1) {
