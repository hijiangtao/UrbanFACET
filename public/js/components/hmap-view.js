...
class mapview {
    ...
    ClusterboundaryDrawing(data, prop, update = false) {
        ...
        let //color = d3.scaleLinear().domain([0, 14])
            ...
            color = ["rgba(255,0,0,0.5)","rgba(255,69,0,0.5)", "rgba(160,32,240,0.5)", "rgba(255,215,0,0.5)","rgba(139,69,19,0.5)", 
                "rgba(154,205,50,0.5)","rgba(173,255,47,0.5)", "rgba(0,255,0,0.5)", "rgba(0,206,209,0.5)", "rgba(127,255,212,0.5)","rgba(255,255,0,0.5)", "rgba(0,191,255,0.5)", "rgba(30,144,255,0.5)", "rgba(255,165,0,0.5)", "rgba(255,20,147,0.5)"
            ],
